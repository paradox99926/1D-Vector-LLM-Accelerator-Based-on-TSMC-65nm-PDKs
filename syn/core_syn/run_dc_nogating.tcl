...
# Target library
set target_library {/home/linux/ieng6/ee260bwi25/xiz225/PDKdata/db/tcbn65gplustc.db} 
...
#redirect [format "%s%s" log/ $top_module _clock_gating.rep] { report_clock_gating }
