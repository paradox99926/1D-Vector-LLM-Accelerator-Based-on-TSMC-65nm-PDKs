...
set_multicycle_path 3 -setup -from [get_cells "sfp_row_instance/clk_gate_sfp_in_temp_reg*"] -to [get_pins "sfp_row_instance/sfp_out"]
set_multicycle_path 3 -setup -from [get_pins "sfp_row_instance/sum_in"] -to [get_pins "sfp_row_instance/sfp_out"]
set_multicycle_path 3 -setup -from [get_pins "sfp_row_instance/clk_o"] -to [get_pins "sfp_row_instance/sum_out"]

set_multicycle_path 2 -hold -from [get_cells "sfp_row_instance/clk_gate_sfp_in_temp_reg*"] -to [get_pins "sfp_row_instance/sfp_out"]
set_multicycle_path 2 -hold -from [get_pins "sfp_row_instance/sum_in"] -to [get_pins "sfp_row_instance/sfp_out"]
set_multicycle_path 2 -hold -from [get_pins "sfp_row_instance/clk_o"] -to [get_pins "sfp_row_instance/sum_out"]